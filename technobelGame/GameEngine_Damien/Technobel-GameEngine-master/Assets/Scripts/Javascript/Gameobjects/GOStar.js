...
function GOStar() {
	...
	this.Transform = {};
	this.Transform.position = new Vector(500,40);
	...
	this.Start = function() {
		if (!this.started) {
			// operation start
			this.Transform.size.x = this.Physics.Collider.size.x = Images["Star"].width;
			this.Transform.size.y = this.Physics.Collider.size.y = Images["Star"].height;
