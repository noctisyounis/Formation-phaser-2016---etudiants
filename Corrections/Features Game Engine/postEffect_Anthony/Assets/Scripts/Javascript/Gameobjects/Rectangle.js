...
function Rectangle(x,y,color) {
	...
	this.Update = function() {
		...
		// this.currentSpeed.x = Tween.Linear(0.5, this.goalSpeed.x, Time.DeltaTime, this.currentSpeed.x,);
		this.Transform.position.x += Number((this.currentSpeed.x).toFixed(1));
		this.GUI();	
	};
	this.GUI = function() {
