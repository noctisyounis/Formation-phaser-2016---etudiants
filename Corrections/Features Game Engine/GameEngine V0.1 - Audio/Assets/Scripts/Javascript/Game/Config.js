...
var AudioPath = 
[
	{ name:'Acoustic', path: 'AudioGame/AudioShort/TechnoGame_Acoustic.mp3'},
	{ name:'Bass', path: 'AudioGame/AudioShort/TechnoGame_Bass.mp3'},
	{ name:'Chorus', path: 'AudioGame/AudioShort/TechnoGame_Chorus.mp3'},
	{ name:'HighNotes', path: 'AudioGame/AudioShort/TechnoGame_HighNotes.mp3'},
	{ name:'Bend', path: 'AudioGame/SFX/TechnoGame_Bend.mp3'}
]
