...
function TweenObjectXSins() {
	this.name = "TweenObjectXSins";
	this.enabled = true;
	this.started = false;
	this.rendered = true;
	...
	this.Awake = function() {
		console.log('%c System:TweenObjectXSins ' + this.name + " Created !", 'background:#222; color:#b00b55');
	};
	this.Start = function() {
		if (!this.started) {
			// operation start
			this.Transform.relativePosition = new Vector(100, 300);
