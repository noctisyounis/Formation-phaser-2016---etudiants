...
function Player() 
{
	...
	this.Awake = function() 
	{
		...
		this.Transform.Size = new Vector(30,30);
	...
	this.Update = function() 
	{
		...
		var me = new Box(this.Physics.Collider.Position.x,
