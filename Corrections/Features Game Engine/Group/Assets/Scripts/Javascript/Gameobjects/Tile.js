...
function Tile(x,y,c) {
	...
	this.Transform.size = new Vector(c,c);
	...
	this.Update = function() {
		if ( this.enabled ) {
			...
			ctx.strokeRect(this.Transform.position.x,this.Transform.position.y,this.Transform.size.x,this.Transform.size.y)
