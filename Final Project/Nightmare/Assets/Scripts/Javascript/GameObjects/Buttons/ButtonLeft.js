 ...
 *
 * */
function ButtonLeft(_x,_y,_scaleX,_scaleY) 
{
	this.name = "ButtonLeft";
	this.enabled = true;
	this.started = false;
	this.rendered = true;
	...
	this.onClicked = function() 
	{
		...
		if (Application.LoadedScene.name == "Title") 
		{
			...
			if (Application.LoadedScene.playerIndex < 0) 
			{
				Application.LoadedScene.playerIndex = PlayersConfig.length - 1;
			}
