 ...
 *
 * */
function ButtonLight(_scaleX,_scaleY) 
{
	...
	this.Transform = {};
	this.Transform.RelativePosition = new Vector(563 * _scaleX ,137 * _scaleY);
	this.Transform.Position = new Vector(563 * _scaleX ,137 * _scaleY);
	this.Transform.Size = new Vector(15,15);
	...
	{
		/*ctx.fillStyle = "rgba(250,250,10,1)";
	...
	this.onHover = function() 
	{
		...
		ctx.arc(this.Transform.Position.x, this.Transform.Position.y,
					this.Transform.Size.x * this.Transform.Scale.x*0.35,
					0, 2*Math.PI,true);
		ctx.closePath();
		ctx.fill();
	...
	this.onClicked = function() 
	{
		...
		Application.LoadedScene.lightOn = !Application.LoadedScene.lightOn;
		this.Physics.countHovered ++;
	}
	/**
