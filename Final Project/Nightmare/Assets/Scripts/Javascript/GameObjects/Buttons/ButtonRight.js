 ...
 *
 * */
function ButtonRight(_x,_y,_scaleX,_scaleY) 
{
	this.name = "ButtonRight";
	this.enabled = true;
	this.started = false;
	this.rendered = true;
	...
	this.Update = function() 
	{
		...
		ctx.stroke();
		ctx.fillStyle = "#000";
		ctx.font = 50*this.Transform.Scale.x + "px Consolas";
		ctx.textBaseline = "middle";
		ctx.textAlign = "center";
		ctx.fillText(">", this.Transform.Position.x, this.Transform.Position.y)
		this.PostUpdate();	
	};
	/**
	 * @function PostUpdate
	...
	this.onClicked = function() 
	{
		...
		if (Application.LoadedScene.name == "Title") 
		{
			Application.LoadedScene.playerIndex++;
			if (Application.LoadedScene.playerIndex == PlayersConfig.length) 
			{
				Application.LoadedScene.playerIndex = 0;
			}
			Application.CurrentPlayer = PlayersConfig[Application.LoadedScene.playerIndex];
		}
		this.Physics.countHovered ++;
	}
	/**
