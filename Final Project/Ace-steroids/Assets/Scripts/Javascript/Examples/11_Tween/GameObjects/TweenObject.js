...
function TweenObject() {
	...
	this.Awake = function() {
		console.log('%c System:TweenObject ' + this.name + " Created !", 'background:#222; color:#b00b55');
	};
	this.Start = function() {
		if (!this.started) {
			// operation start
			this.Transform.relativePosition = new Vector(100, 400);
