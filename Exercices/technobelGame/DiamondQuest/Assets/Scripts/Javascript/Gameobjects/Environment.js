...
function Environment(config) {
	...
	this.Start = function() {
		if (!this.started) {
			...
			this.Renderer.Material.Source 	= Images[config.name];
			this.Transform.position 		= config.position;
			this.Transform.scale 			= config.scale || this.Transform.scale;
			this.Transform.size 			= config.size;
			this.Renderer.id 				= config.id;
