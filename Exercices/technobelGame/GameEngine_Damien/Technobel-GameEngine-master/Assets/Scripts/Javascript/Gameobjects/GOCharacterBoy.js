...
function GOCharacterBoy() {
	...
	this.Transform.size = new Vector(110,170);
	...
	this.Start = function() {
		...
		// direction before Update (collider)
	...
	this.SetCollider = function(){
		this.Physics.Collider.x = this.Transform.position.x + 15;
		this.Physics.Collider.y = this.Transform.position.y + 60;

		this.Physics.Collider.w = this.Transform.size.x * this.Transform.scale.x - 30;
		this.Physics.Collider.h = this.Transform.size.y * this.Transform.scale.y - 90;
	}
	this.GUI = function() {
