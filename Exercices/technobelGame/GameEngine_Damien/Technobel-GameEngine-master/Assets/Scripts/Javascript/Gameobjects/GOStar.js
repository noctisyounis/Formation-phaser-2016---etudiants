...
function GOStar(x, y) {
	...
	this.Transform.size = new Vector(70,90);
	...
	this.Physics.Collider = new Box(this.Transform.position.x+10,
									this.Transform.position.y+28,
									this.Transform.size.x-20,
									this.Transform.size.y-42);
